...
public class JadwalLainModel extends RealmObject {
    ...
    public JadwalLainModel(int no_jl, String nama_jl, Date waktus_jl, Date waktuf_jl, String tempat_jl, String deskripsi_jl, int status_jl, String author, Date created_at, Date updated_at, String noonline_jl) {
        this.no_jl = no_jl;
